---
name: "agent-spectrum"
description: "Use when OpenClaw needs to score an agent or itself with the Agent Spectrum six-axis framework, run the quick or deep edition, identify type and faction, or analyze weakest-axis and complementary-partner fit."
---

# Agent Spectrum

This is an OpenClaw workspace-skill wrapper for the canonical `Agent Spectrum` skill in this repository.
